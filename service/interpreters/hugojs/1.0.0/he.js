...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 37040,
    DYNAMIC_BASE = 5279920,
    DYNAMICTOP_PTR = 37024;
...
var ASM_CONSTS = {
 ...
 2199: function($0, $1, $2) {if( $1 < 0 ) { hugoui.print(String.fromCharCode(256 + $1), $2); } else { hugoui.print(AsciiToString($0), $2); }},  
 2315: function($0, $1) {hugoui.font.set($0, $1);},  
 2344: function($0, $1) {hugoui.color.set( 'text', $0, $1 );},  
 2384: function($0, $1) {hugoui.color.set( 'background', $0, $1 );},  
 2434: function() {haven.file.syncfs();},  
 2459: function() {hugoui.restoreUI();},  
 2802: function() {if( hugoui.opcodes ) { hugoui.opcodes.process(); }},  
 3809: function() {haven.state.autosave.remove();}
};
