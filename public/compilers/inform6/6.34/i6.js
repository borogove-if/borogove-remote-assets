var Module = (function() {
    ...
    return function(Module) {
        ...
        var DYNAMIC_BASE = 5443952,
            DYNAMICTOP_PTR = 201040;
            ...
            open: function(path, flags, mode, fd_start, fd_end) {
                ...
                if (Module["logReadFiles"] && !(flags & 1)) {
                    ...
                    if (!(path in FS.readFiles)) {
                        FS.readFiles[path] = 1;
                        console.log(
                            "FS.trackingDelegate error on read file: " + path
                        );
                    }
                }
                try {
        ...
        var ___tm_current = 200896;
        var ___tm_timezone = (stringToUTF8("GMT", 200944, 4), 200944);
        function _tzset() {
